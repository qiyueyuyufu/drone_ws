...
: ${AMENT_CURRENT_PREFIX:="/home/qiyue/ros2_learn/test/install/test_project"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test_project/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test_project/environment/path.sh"
